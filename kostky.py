...
open('kostky.txt', 'wb').write(s.content)
states = pandas.read_csv("kostky.txt")
...
open('callcentrum.txt', 'wb').write(c.content)
states = pandas.read_csv("kostky.txt")

kostky = pandas.read_csv("callcentrum.txt", header=None)
print(kostky.head())
...
casyCelkem = casy.dt.second + casy.dt.minute * 60

#casyCelkem.hist()
#plt.show()
# casyCelkem.plot(kind="box", whis=[0,100])
# plt.show()
